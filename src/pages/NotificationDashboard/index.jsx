...
const NotificationDashboard = () => {
  ...
  const handleAddCampaign = async (newCampaignData) => {
    try {
      ...
      const res = await api.post("/notification-campaign", formData, {
  ...
  const handleAction = async (id, actionType) => {
    try {
      if (actionType === "delete") {
        await api.delete(`/notification-campaign/${id}`);
        ...
        await api.put(`/notification-campaign/${id}`, { status: newStatus });
